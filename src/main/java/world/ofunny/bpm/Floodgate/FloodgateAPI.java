		...
		switch(Config.get().getFloodgateVersion()) {
            ...
            default:
            	...
            	if(isClass("org.geysermc.floodgate.api.FloodgateApi")) {
            		...
            		logger.logWarning("Floodgate API version 2.x has been detected – plugin running in 'solo mode' without Floodgate, all players will be treated as Java players!");
